"""
Django settings for jb_backend_project project.
...
SPECTACULAR_SETTINGS = {
    "TITLE": "HireSpot API",
    "DESCRIPTION": "API documentation for the HireSpot App",
    "VERSION": "1.0.0",
...
ROOT_URLCONF = "jb_backend_project.urls"
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'hirespot/static'),
]
